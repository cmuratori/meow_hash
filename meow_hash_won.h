...
#define Meow128_AESDEC_Mem(Prior, XOrPtr) _mm_aesdec_si128(*(meow_u128 *)(XOrPtr), (Prior))
...
#define Meow128_AESDEC_Zero(Prior) _mm_aesdec_si128(Prior, Meow128_Zero())
...
MeowHash1(meow_u64 Seed, meow_u64 TotalLengthInBytes, void *SourceInit)
{
    ...
    meow_u128 S0 = Meow128_Set64x2(Seed - TotalLengthInBytes,
...
#ifdef WON
    meow_u128 H = Meow128_Zero();

    switch(TotalLengthInBytes >> 4) {
      case 16:
        SF = Meow128_AESDEC_Mem(SF, Source + 240);
        H  = Meow128_AESDEC(H, SF);
      case 15:
        SE = Meow128_AESDEC_Mem(SE, Source + 224);
        H  = Meow128_AESDEC(H, SE);
      case 14:
        SD = Meow128_AESDEC_Mem(SD, Source + 208);
        H  = Meow128_AESDEC(H, SD);
      case 13:
        SC = Meow128_AESDEC_Mem(SC, Source + 192);
        H  = Meow128_AESDEC(H, SC);
      case 12:
        SB = Meow128_AESDEC_Mem(SB, Source + 176);
        H  = Meow128_AESDEC(H, SB);
      case 11:
        SA = Meow128_AESDEC_Mem(SA, Source + 160);
        H  = Meow128_AESDEC(H, SA);
      case 10:
        S9 = Meow128_AESDEC_Mem(S9, Source + 144);
        H  = Meow128_AESDEC(H, S9);
      case  9:
        S8 = Meow128_AESDEC_Mem(S8, Source + 128);
        H  = Meow128_AESDEC(H, S8);
      case  8:
        S7 = Meow128_AESDEC_Mem(S7, Source + 112);
        H  = Meow128_AESDEC(H, S7);
      case  7:
        S6 = Meow128_AESDEC_Mem(S6, Source +  96);
        H  = Meow128_AESDEC(H, S6);
      case  6:
        S5 = Meow128_AESDEC_Mem(S5, Source +  80);
        H  = Meow128_AESDEC(H, S5);
      case  5:
        S4 = Meow128_AESDEC_Mem(S4, Source +  64);
        H  = Meow128_AESDEC(H, S4);
      case  4:
        S3 = Meow128_AESDEC_Mem(S3, Source +  48);
        H  = Meow128_AESDEC(H, S3);
      case  3:
        S2 = Meow128_AESDEC_Mem(S2, Source +  32);
        H  = Meow128_AESDEC(H, S2);
      case  2:
        S1 = Meow128_AESDEC_Mem(S1, Source +  16);
        H  = Meow128_AESDEC(H, S1);
      case  1:
        S0 = Meow128_AESDEC_Mem(S0, Source);
        H  = Meow128_AESDEC(H, S0);

        if (TotalLengthInBytes & 0xF)
        {
            H = Meow128_AESDEC(Meow128_LoadUnaligned(Source + TotalLengthInBytes - 16),
                               H);
        }

        return Meow128_AESDEC_Zero(H);
      case  0: {
        meow_u64 Has8 = TotalLengthInBytes & 8;
        meow_u64 Has4 = TotalLengthInBytes & 4;
        meow_u64 Has2 = TotalLengthInBytes & 2;
        meow_u64 Has1 = TotalLengthInBytes & 1;
        if (Has8)
        {
          S0 = Meow128_AESDEC(_mm_loadu_si64(Source), S0);
          H  = Meow128_AESDEC(H, S0);
        }
        if (Has4)
        {
          S1 = Meow128_AESDEC(_mm_loadu_si32(Source + Has8), S1);
          H  = Meow128_AESDEC(H, S1);
        }
        if (Has2)
        {
          S2 = Meow128_AESDEC(_mm_loadu_si16(Source + Has8 + Has4), S2);
          H  = Meow128_AESDEC(H, S2);
        }
        if (Has1)
        {
          meow_u128 Partial = Meow128_Zero();
          Partial = _mm_insert_epi8(Partial, Source + Has8 + Has4 + Has2, 8);
          S3 = Meow128_AESDEC(Partial, S3);
          H  = Meow128_AESDEC(H, S3);
        }
        return Meow128_AESDEC_Zero(H);
      }
    ...
    switch(Len & 0xF)
    {
        ...
        {
            meow_u128 Partial = _mm_loadl_epi64((const __m128i *)Source);
